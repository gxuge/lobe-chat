export default {
  ...
  authErrors: {
    ...
    AccountNotLinked: '该邮箱已绑定其他登录方式，请使用对应的方式登录',
    Callback: '登录回调失败，请重试',
    Configuration: '服务器配置错误，请联系管理员',
    CredentialsSignin: '邮箱或密码错误，请重新输入',
    Default: '登录失败，请稍后重试',
    EmailCreateAccount: '无法创建邮箱账户，请重试',
    EmailSignin: '邮箱验证失败，请检查您的邮箱',
    OAuthAccountNotLinked: '该账户已绑定其他登录方式',
    OAuthCallback: 'OAuth回调失败，请重试',
    OAuthCreateAccount: '无法创建OAuth账户，请重试',
    OAuthSignin: '第三方登录失败，请重试',
    SessionRequired: '会话已过期，请重新登录',
    Signin: '登录失败，请重试',
    Verification: '验证失败，验证链接可能已过期',
  },
  date: {
    prevMonth: '上个月',
    recent30Days: '最近30天',
